...
try {
  ...
  if ($initialize.result.serverInfo.version -ne '1.4.2') { throw 'TRAE MCP version is not 1.4.2.' }
  ...
  if (-not $health.connected -or $health.helperVersion -ne '1.4.2') { throw 'TRAE MCP live health handshake was not recorded.' }
